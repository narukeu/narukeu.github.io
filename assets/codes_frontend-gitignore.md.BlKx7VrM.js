import{_ as n,c as a,o as p,ag as l}from"./chunks/framework.lo-SgHyK.js";const m=JSON.parse('{"title":"前端通用 .gitignore","description":"","frontmatter":{},"headers":[],"relativePath":"codes/frontend-gitignore.md","filePath":"codes/frontend-gitignore.md","lastUpdated":1756217955000}'),e={name:"codes/frontend-gitignore.md"};function i(c,s,t,o,r,d){return p(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="前端通用-gitignore" tabindex="-1">前端通用 <code>.gitignore</code> <a class="header-anchor" href="#前端通用-gitignore" aria-label="Permalink to “前端通用 .gitignore”">​</a></h1><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># Windows thumbnail cache files</span></span>
