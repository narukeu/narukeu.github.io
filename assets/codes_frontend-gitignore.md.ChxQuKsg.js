import{_ as n,c as a,o as p,af as l}from"./chunks/framework.CkW8_0d0.js";const m=JSON.parse('{"title":"前端通用 .gitignore","description":"","frontmatter":{},"headers":[],"relativePath":"codes/frontend-gitignore.md","filePath":"codes/frontend-gitignore.md","lastUpdated":1756217955000}'),e={name:"codes/frontend-gitignore.md"};function i(c,s,t,o,r,d){return p(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="前端通用-gitignore" tabindex="-1">前端通用 <code>.gitignore</code> <a class="header-anchor" href="#前端通用-gitignore" aria-label="Permalink to &quot;前端通用 \`.gitignore\`&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Windows thumbnail cache files</span></span>
